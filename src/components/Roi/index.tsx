...
export function Roi() {
  return (
    <section className="flex flex-col w-full justify-center items-center bg-black py-10 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row justify-center items-center gap-6 md:gap-8 lg:gap-10 w-full max-w-6xl">
        
        {/* Primeiro Card */}
        <div className="bg-[#1D1D1F] w-full max-w-[400px] lg:max-w-none lg:w-1/2 h-auto min-h-[500px] sm:min-h-[550px] flex flex-col justify-between items-center rounded-3xl p-6 sm:px-8 sm:pt-8 pb-0">
